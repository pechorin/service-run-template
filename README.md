...
ruby приложение + sidekiq демон + rabbitmiq демон + postgresql12 + elasticsearch6 + statsd демон
...
kubernetes кластер, master-slave postgresql кластер, эжнедневные бэкапы в 21:00
...
json логи, собираемые в kubernetes кластере отправляются в наш elasticsearch, каждый лог должен начинаться с "app":"имя приложения"
